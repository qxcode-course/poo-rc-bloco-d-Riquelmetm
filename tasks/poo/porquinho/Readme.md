...
![cover](../../.tko/cache/poo/base/porquinho/cover.jpg)
...
![diagrama](../../.tko/cache/poo/base/porquinho/diagrama.png)

[![youtube icon](../../.tko/cache/poo/base/porquinho/../yousolver.png)](https://youtu.be/rR2bIGsJjaw?si=VMEWLD5vWozDPX02)
...
<!-- links .cache/draft -->
- [Solver.java](../../.tko/cache/poo/base/porquinho/.cache/draft/Solver.java)
- cpp
  - [shell.cpp](../../.tko/cache/poo/base/porquinho/.cache/draft/cpp/shell.cpp)
- java
  - [Shell.java](../../.tko/cache/poo/base/porquinho/.cache/draft/java/Shell.java)
- ts
  - [shell.ts](../../.tko/cache/poo/base/porquinho/.cache/draft/ts/shell.ts)
<!-- links -->
